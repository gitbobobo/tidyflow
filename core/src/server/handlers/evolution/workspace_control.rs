    ...
    pub(super) async fn build_snapshot(&self, _ctx: &HandlerContext) -> SnapshotResult {
        ...
        for w in state.workspaces.values() {
            ...
            workspace_items.push(EvolutionWorkspaceItem {
                ...
                coordination_peer_node_id: w.coordination_peer_node_id.clone(),
                coordination_peer_node_name: w.coordination_peer_node_name.clone(),
                coordination_peer_project: w.coordination_peer_project.clone(),
