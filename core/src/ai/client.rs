...
impl OpenCodeAgent {
    ...
    fn selection_hint_from_session(
        ...
        Self::selection_hint_from_value(&value)
    }

    fn selection_hint_from_value(
...
fn map_opencode_hub_stream(
    rx: tokio::sync::broadcast::Receiver<super::event_hub::HubEvent>,
    directory: &str,
    session_id: &str,
) -> AiEventStream {
            ...
            Ok(hub_event) => {
                ...
                match bus_event.event_type.as_str() {
                    ...
                    "message.updated" => {
                        ...
                        let selection_hint = OpenCodeAgent::selection_hint_from_value(info);
