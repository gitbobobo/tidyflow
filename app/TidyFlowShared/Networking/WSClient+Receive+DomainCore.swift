...
extension WSClient {
    public func handleSystemDomain(_ action: String, json: [String: Any]) -> Bool {
        switch action {
        case "hello", "pong":
            return true
    ...
    public func handleTerminalDomain(_ action: String, json: [String: Any]) -> Bool {
        switch action {
        case "output_batch":
        ...
        case "term_list":
            if let result = TermListResult.from(json: json) {
                ...
                CoreWSLog.ws.info("Received term_list: \(result.items.count) terminals, \(remoteSubs.count) remote subscribers")
                if let handler = terminalMessageHandler {
                ...
                CoreWSLog.ws.warning("Failed to parse term_list response")
            }
            return true
        case "term_closed":
        ...
        case "remote_term_changed":
            CoreWSLog.ws.info("Received remote_term_changed notification")
            if let handler = terminalMessageHandler {
    ...
    public func handleGitDomain(_ action: String, json: [String: Any]) -> Bool {
        switch action {
    ...
    public func handleFileDomain(_ action: String, json: [String: Any]) -> Bool {
        switch action {
    ...
    public func handleHealthDomain(_ action: String, json: [String: Any]) -> Bool {
        switch action {
    ...
    public func handleCoordinatorDomain(_ action: String, json: [String: Any]) -> Bool {
        switch action {
