...
extension WSClient {
    public func handleProjectDomain(_ action: String, json: [String: Any]) -> Bool {
        switch action {
        case "project_imported":
            if let result = ProjectImportedResult.from(json: json) {
                ...
                CoreWSLog.ws.error("Failed to parse ProjectImportedResult")
    ...
    public func handleEvolutionDomain(_ action: String, json: [String: Any]) -> Bool {
        switch action {
    ...
    public func handleNodeDomain(_ action: String, json: [String: Any]) -> Bool {
        switch action {
