...
enum CoreErrorCode: String, Hashable {
    // MARK: 项目/工作区
    ...
    static func parse(_ raw: String?) -> CoreErrorCode {
    ...
    var requiresWorkspaceContext: Bool {
        switch self {
        case .projectNotFound, .workspaceNotFound,
...
struct CoreError {
    ...
    static func from(json: [String: Any]) -> CoreError {
    ...
    static func fromEvoError(json: [String: Any]) -> CoreError {
    ...
    func belongsTo(project: String?, workspace: String?) -> Bool {
