...
struct EvolutionImplementAgentProfileInfoV2 {
    let aiTool: AIChatTool
    let mode: String?
    let model: EvolutionModelSelectionV2?
    let configOptions: [String: Any]
    ...
    init(
        aiTool: AIChatTool = .codex,
        mode: String? = nil,
        model: EvolutionModelSelectionV2? = nil,
        configOptions: [String: Any] = [:]
    ) {
        self.aiTool = aiTool
        self.mode = mode
    ...
    static func from(json: [String: Any]) -> EvolutionImplementAgentProfileInfoV2 {
        let aiTool = parseAIChatTool(json["ai_tool"] ?? json["aiTool"]) ?? .codex
        let mode = parseOptionalString(json["mode"])
        let providerHint = parseOptionalString(json["provider_id"])
            ?? parseOptionalString(json["providerId"])
...
struct EvolutionImplementAgentProfilesV2 {
    let general: EvolutionImplementAgentProfileInfoV2
    let visual: EvolutionImplementAgentProfileInfoV2
    let advanced: EvolutionImplementAgentProfileInfoV2

    init(
        general: EvolutionImplementAgentProfileInfoV2 = EvolutionImplementAgentProfileInfoV2(),
        visual: EvolutionImplementAgentProfileInfoV2 = EvolutionImplementAgentProfileInfoV2(),
        advanced: EvolutionImplementAgentProfileInfoV2 = EvolutionImplementAgentProfileInfoV2()
    ) {
    ...
    static var `default`: EvolutionImplementAgentProfilesV2 {
        EvolutionImplementAgentProfilesV2()
    }

    static func from(json: [String: Any]) -> EvolutionImplementAgentProfilesV2 {
        let general = parseDictionary(json["general"]).map { EvolutionImplementAgentProfileInfoV2.from(json: $0) }
            ?? EvolutionImplementAgentProfileInfoV2()
        let visual = parseDictionary(json["visual"]).map { EvolutionImplementAgentProfileInfoV2.from(json: $0) }
            ?? EvolutionImplementAgentProfileInfoV2()
        let advanced = parseDictionary(json["advanced"]).map { EvolutionImplementAgentProfileInfoV2.from(json: $0) }
            ?? EvolutionImplementAgentProfileInfoV2()
        return EvolutionImplementAgentProfilesV2(
            general: general,
            visual: visual,
            advanced: advanced
        )
